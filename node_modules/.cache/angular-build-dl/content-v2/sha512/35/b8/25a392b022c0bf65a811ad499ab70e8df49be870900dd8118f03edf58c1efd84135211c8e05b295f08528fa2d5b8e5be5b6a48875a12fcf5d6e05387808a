...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppTripsConnectorDownConnectorDownHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<div class=\"imgCls\"><img src=\"assets/images/cyan-connector.png\" /></div>";
    /***/
  },
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppTripsConnectorUpConnectorUpHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<img src=\"assets/images/orange-connector.png\" />";
    /***/
  },
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(AppComponent, [{
        ...
        key: "onAddPickupPoints",
        value: function onAddPickupPoints() {
          var startPoint = this.addRoutesForm.value.startPoint.substring(0, 3).toUpperCase();
          var endPoint = this.addRoutesForm.value.endPoint.substring(0, 3).toUpperCase();
          ...
          if (this.consecutive_count == 0) this.addedRoutesArr[this.arrlength - 1].type = "straightline";

          if (this.arrlength > 1) {
            if (this.addedRoutesArr[this.arrlength - 2].startPoint != this.addedRoutesArr[this.arrlength - 1].startPoint && this.addedRoutesArr[this.arrlength - 2].startPoint != this.addedRoutesArr[this.arrlength - 1].endPoint && this.addedRoutesArr[this.arrlength - 2].endPoint == this.addedRoutesArr[this.arrlength - 1].startPoint && this.addedRoutesArr[this.arrlength - 2].endPoint != this.addedRoutesArr[this.arrlength - 1].endPoint) {
              ...
              this.consecutive_count = 0;
            } else if (this.addedRoutesArr[this.arrlength - 2].startPoint != this.addedRoutesArr[this.arrlength - 1].startPoint && this.addedRoutesArr[this.arrlength - 2].startPoint != this.addedRoutesArr[this.arrlength - 1].endPoint && this.addedRoutesArr[this.arrlength - 2].endPoint != this.addedRoutesArr[this.arrlength - 1].startPoint && this.addedRoutesArr[this.arrlength - 2].endPoint == this.addedRoutesArr[this.arrlength - 1].endPoint || this.addedRoutesArr[this.arrlength - 2].startPoint != this.addedRoutesArr[this.arrlength - 1].startPoint && this.addedRoutesArr[this.arrlength - 2].startPoint == this.addedRoutesArr[this.arrlength - 1].endPoint && this.addedRoutesArr[this.arrlength - 2].endPoint != this.addedRoutesArr[this.arrlength - 1].startPoint && this.addedRoutesArr[this.arrlength - 2].endPoint != this.addedRoutesArr[this.arrlength - 1].endPoint) {
              ...
              this.consecutive_count = 0;
            } else if (this.addedRoutesArr[this.arrlength - 2].startPoint == this.addedRoutesArr[this.arrlength - 1].startPoint && this.addedRoutesArr[this.arrlength - 2].startPoint != this.addedRoutesArr[this.arrlength - 1].endPoint && this.addedRoutesArr[this.arrlength - 2].endPoint != this.addedRoutesArr[this.arrlength - 1].startPoint && this.addedRoutesArr[this.arrlength - 2].endPoint == this.addedRoutesArr[this.arrlength - 1].endPoint) {
              ++this.consecutive_count;
              this.addedRoutesArr[this.arrlength - 2].type = "levelup";
              this.addedRoutesArr[this.arrlength - 1].type = "levelup";
              if (this.addedRoutesArr[this.arrlength - 2 - this.consecutive_count]) this.addedRoutesArr[this.arrlength - 2 - this.consecutive_count].type = "connectorup";
            } else {}
          } else {
          ...
          console.log(this.addedRoutesArr); // console.log(this.addedRoutesArr[0]);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _trips_connector_down_connector_down__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./trips/connector-down/connector-down */
    "./src/app/trips/connector-down/connector-down.ts");
    /* harmony import */


    var _trips_connector_up_connector_up__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./trips/connector-up/connector-up */
    "./src/app/trips/connector-up/connector-up.ts"); // import { TripsModule } from "./trips/trips.module";
  ...
  /***/
  function srcAppTripsConnectorDownConnectorDownTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ConnectorDownComponent", function () {
      return ConnectorDownComponent;
    });
    /* harmony import */
    ...
    var ConnectorDownComponent = function ConnectorDownComponent() {
      _classCallCheck(this, ConnectorDownComponent);
    };

    ConnectorDownComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "app-connector-down",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./connector-down.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/trips/connector-down/connector-down.html")).default //   styleUrls: ["./app.component.css"]
  ...
  /***/
  function srcAppTripsConnectorUpConnectorUpTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ConnectorUpComponent", function () {
      return ConnectorUpComponent;
    });
    /* harmony import */
    ...
    var ConnectorUpComponent = function ConnectorUpComponent() {
      _classCallCheck(this, ConnectorUpComponent);
    };

    ConnectorUpComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "app-connector-up",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./connector-up.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/trips/connector-up/connector-up.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./connector.up.css */
      "./src/app/trips/connector-up/connector.up.css")).default]
  ...
  /***/
  function srcAppTripsConnectorUpConnectorUpCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\Angular-Workspace\assignments\transport-web-app\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
